...
import retail.view.main.panel.bot.manipulator.inventorymanipulator.panel.AddViewDelete;
import retail.view.main.panel.bot.manipulator.inventorymanipulator.panel.InventoryManipulatorCard;
...
public class MainInventoryController {
    ...
    public MainInventoryController(BottomBorderPanel bottomBorderPanel, TopBorderPanel topBorderPanel) {
        ...
        this.mainCard = bottomBorderPanel.getBottomMainCard().getInventory();

        new AddInventoryController(bottomBorderPanel,topBorderPanel);
        new ViewInventoryController(bottomBorderPanel);
        new ProductInventoryController(bottomBorderPanel);
