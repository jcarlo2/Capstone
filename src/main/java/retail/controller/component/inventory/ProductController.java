...
import retail.view.main.panel.bot.manipulator.inventory.panel.Product;

import java.math.BigDecimal;

public class ProductController {
    private final retail.controller.database.ProductController controller = new retail.controller.database.ProductController();
