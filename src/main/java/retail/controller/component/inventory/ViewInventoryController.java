...
import retail.view.main.panel.bot.manipulator.inventorymanipulator.panel.Delete;
...
public class ViewInventoryController {
    ...
    public ViewInventoryController(@NotNull BottomBorderPanel bottomBorderPanel) {
        delete = bottomBorderPanel.getManipulatorCard().getInventoryManipulator().getDeletePanel();
        table = bottomBorderPanel.getBottomMainCard().getInventory().getDelete().getTableInventory();
